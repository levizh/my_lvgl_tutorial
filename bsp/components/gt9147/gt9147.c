 ...
 *******************************************************************************
 * @file  gt9147.c
 * @brief This file provides firmware functions for IO expand IC GT9147.
 @verbatim
   Change Logs:
   Date             Author          Notes
 ...
 */
/**
 * @brief  Initialize IO expand IC GT9147.
 * @param  none
 * @retval none
 */
...
/**
 * @brief  Reset IO expand IC GT9147.
 * @param  none
 * @retval none
 */
...
/**
 * @brief  Initialize IO expand IC GT9147 interrupt.
 * @param  none
 * @retval none
 */
