...
||||||| .r432
    I2Cx_Start(TCA9539_I2C_CH);
    I2Cx_SendAddr(TCA9539_I2C_CH, (TCA9539_ADDR | TCA9539_WRITE));
    I2Cx_SendData(TCA9539_I2C_CH, (uint8_t *)&u8Reg, 1UL);
    I2Cx_SendData(TCA9539_I2C_CH, (uint8_t *)&u8Val, 1UL);
    I2Cx_Stop(TCA9539_I2C_CH);
=======
...
<<<<<<< .mine
    ...
    I2Cx_Stop(TCA9539_I2C_CH, TCA9539_TIMEOUT);
||||||| .r432
    I2Cx_Restart(TCA9539_I2C_CH);
    I2Cx_SendAddr(TCA9539_I2C_CH, (TCA9539_ADDR | TCA9539_READ));
    I2Cx_RcvData(TCA9539_I2C_CH, u8Val, 1UL);
    I2Cx_Stop(TCA9539_I2C_CH);
=======
