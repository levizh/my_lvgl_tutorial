 ...
 * @{
 */
#define SMC_CS_PORT                             (GPIO_PORT_G)   /* PG10 - EXMC_CE2 */
#define SMC_CS_PIN                              (GPIO_PIN_10)

#define SMC_WE_PORT                             (GPIO_PORT_C)   /* PC00 - EXMC_WE */
#define SMC_WE_PIN                              (GPIO_PIN_00)
...
#define SMC_OE_PORT                             (GPIO_PORT_F)   /* PF11 - EXMC_OE */
#define SMC_OE_PIN                              (GPIO_PIN_11)
...
en_result_t BSP_SMC_IS62WV51216_Init(void)
{
    ...
    stcSmcInit.stcTimingCfg.u32RC = 3UL;
...
/**
 * @defgroup EV_HC32F4A0_LQFP176_IS62WV51216_Local_Functions HC32F4A0 LQFP176 EVB IS62WV51216 Local Functions
 * @{
 */
