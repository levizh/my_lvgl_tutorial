 ...
 * @{
 */
#define DCU_DATA_BITS_8                         (0UL)                   /*!< DCU data size: 8 bit */
 ...
 * @{
 */
#define DCU_COM1_TRIG_DISABLE                   (0x00UL)
#define DCU_COM1_TRIG_ENABLE                    (AOS_DCU_1_TRGSEL_COMTRG_EN_0)

#define DCU_COM2_TRIG_DISABLE                   (0x00UL)
#define DCU_COM2_TRIG_ENABLE                    (AOS_DCU_1_TRGSEL_COMTRG_EN_1)
/**
 * @}
 */
