 ...
 *******************************************************************************
 */
#ifndef __HC32F4A0_EXMC_DMC_H__
#define __HC32F4A0_EXMC_DMC_H__
...
typedef struct
{
    ...
    uint32_t    u32CkeOutputSel;            /*!< Defines the CKE output selection.
                                                 This parameter can be a value of @ref EXMC_DMC_CKE_Output_Slection */
 ...
 * @{
 */
#define EXMC_DMC_MEM_WIDTH_16                   ((uint32_t)0UL)
 ...
 * @{
 */
#define EXMC_DMC_CHIP_0                         ((uint32_t)0UL)     /*!< Chip 0 */
#define EXMC_DMC_CHIP_1                         ((uint32_t)1UL)     /*!< Chip 1 */
#define EXMC_DMC_CHIP_2                         ((uint32_t)2UL)     /*!< Chip 2 */
#define EXMC_DMC_CHIP_3                         ((uint32_t)3UL)     /*!< Chip 3 */
/**
 * @}
 */
 ...
 * @{
 */
#define EXMC_DMC_BANK_0                         ((uint32_t)0UL)     /*!< Bank 0 */
#define EXMC_DMC_BANK_1                         ((uint32_t)1UL)     /*!< Bank 1 */
#define EXMC_DMC_BANK_2                         ((uint32_t)2UL)     /*!< Bank 2 */
#define EXMC_DMC_BANK_3                         ((uint32_t)3UL)     /*!< Bank 3 */
/**
 * @}
 */
 ...
 * @{
 */
#define EXMC_DMC_CURR_STATUS_CONFIGURE          ((uint32_t)0UL)
 ...
 * @{
 */
#define EXMC_DMC_CTL_STATE_GO                   ((uint32_t)0UL)
#define EXMC_DMC_CTL_STATE_SLEEP                ((uint32_t)1UL)
#define EXMC_DMC_CTL_STATE_WAKEUP               ((uint32_t)2UL)
#define EXMC_DMC_CTL_STATE_PAUSE                ((uint32_t)3UL)
#define EXMC_DMC_CTL_STATE_CONFIGURE            ((uint32_t)4UL)
/**
 * @}
 */
 ...
 * @{
 */
#define EXMC_DMC_CMD_PRECHARGEALL               ((uint32_t)0UL)     /*!< Precharge all */
 ...
 * @{
 */
#define EXMC_DMC_REFRESH_PERIOD_MAX             ((uint32_t)0x00007FFFUL)
/**
 * @}
 */
 ...
 * @{
 */
#define EXMC_DMC_CS_DECODE_ROWBANKCOL           ((uint32_t)0UL)     /*!< Row -> Bank -> Column */
 ...
 * @{
 */
#define EXMC_DMC_COLUMN_BITS_NUM_8              ((uint32_t)0UL)
 ...
 * @{
 */
#define EXMC_DMC_ROW_BITS_NUM_11                ((uint32_t)0UL)
...
#define EXMC_DMC_AUTO_PRECHARGE_A10             ((uint32_t)0UL)
/**
 * @}
 */

/**
 * @defgroup EXMC_DMC_CKE_Output_Slection EXMC DMC CKE Output Slection
 * @{
 */
#define EXMC_DMC_CKE_OUTPUT_ENABLE              ((uint32_t)0UL)
 ...
 * @{
 */
#define EXMC_DMC_MEMCLK_NORMAL_OUTPUT           ((uint32_t)0UL)
 ...
 * @{
 */
#define EXMC_DMC_MEM_BURST_1                    ((uint32_t)0UL)
 ...
 * @{
 */
#define EXMC_DMC_AUTO_REFRESH_CHIP_0            ((uint32_t)0UL)
 ...
 * @{
 */
#define EXMC_DMC_ADDR_MASK_16MB                 ((uint32_t)0xFFUL)
#define EXMC_DMC_ADDR_MASK_32MB                 ((uint32_t)0xFEUL)
#define EXMC_DMC_ADDR_MASK_64MB                 ((uint32_t)0xFCUL)
#define EXMC_DMC_ADDR_MASK_128MB                ((uint32_t)0xF8UL)
/**
 * @}
 */
 ...
 * @retval None
 */
__STATIC_INLINE void EXMC_DMC_SetState(uint32_t u32State)
{
...
{
    return READ_REG32(M4_DMC->STSR) & DMC_STSR_STATUS;
}
