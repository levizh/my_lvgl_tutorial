...
#define GPIO_PIN_MASK               ((uint16_t)0xFFFFU)  /*!< PIN mask for assert test */
...
/** @defgroup GPIO_Port_source GPIO port source
  * @{
  */
#define GPIO_PORT_A                 ((uint8_t)0x00U)  /*!< Port A selected  */
#define GPIO_PORT_B                 ((uint8_t)0x01U)  /*!< Port B selected  */
#define GPIO_PORT_C                 ((uint8_t)0x02U)  /*!< Port C selected  */
#define GPIO_PORT_D                 ((uint8_t)0x03U)  /*!< Port D selected  */
#define GPIO_PORT_E                 ((uint8_t)0x04U)  /*!< Port E selected  */
#define GPIO_PORT_F                 ((uint8_t)0x05U)  /*!< Port F selected  */
#define GPIO_PORT_G                 ((uint8_t)0x06U)  /*!< Port G selected  */
#define GPIO_PORT_H                 ((uint8_t)0x07U)  /*!< Port H selected  */
#define GPIO_PORT_I                 ((uint8_t)0x08U)  /*!< Port I selected  */
/**
 * @}
 */
 ...
 * @{
 */
#define GPIO_PORTA_IDX              ((uint16_t)0x0001U)
#define GPIO_PORTB_IDX              ((uint16_t)0x0002U)
#define GPIO_PORTC_IDX              ((uint16_t)0x0004U)
#define GPIO_PORTD_IDX              ((uint16_t)0x0008U)
#define GPIO_PORTE_IDX              ((uint16_t)0x0010U)
#define GPIO_PORTF_IDX              ((uint16_t)0x0020U)
#define GPIO_PORTG_IDX              ((uint16_t)0x0040U)
#define GPIO_PORTH_IDX              ((uint16_t)0x0080U)
#define GPIO_PORTI_IDX              ((uint16_t)0x0100U)
#define GPIO_PORT_ALL               ((uint16_t)0x01FFU)

#define GPIO_PORT_MASK              ((uint16_t)0x01FFU)
/**
 * @}
 */
...
#define GPIO_FUNC_2_TIM41       (GPIO_FUNC_2)   /*!< TIM4 channel*/
#define GPIO_FUNC_2_TIM41_PCT   (GPIO_FUNC_2)   /*!< TIM4 channel 1 @todo */
#define GPIO_FUNC_2_TIM41_ADSM  (GPIO_FUNC_2)   /*!< TIM4 channel 1 @todo */
#define GPIO_FUNC_2_TIM41_CLK   (GPIO_FUNC_2)   /*!< TIM4 channel 1 clock input */
#define GPIO_FUNC_2_TIM41_OUH   (GPIO_FUNC_2)   /*!< TIM4 channel 1 U-phase output high */
#define GPIO_FUNC_2_TIM41_OUL   (GPIO_FUNC_2)   /*!< TIM4 channel 1 U-phase output low */
#define GPIO_FUNC_2_TIM41_OVH   (GPIO_FUNC_2)   /*!< TIM4 channel 1 V-phase output high */
#define GPIO_FUNC_2_TIM41_OVL   (GPIO_FUNC_2)   /*!< TIM4 channel 1 V-phase output low */
#define GPIO_FUNC_2_TIM41_OWH   (GPIO_FUNC_2)   /*!< TIM4 channel 1 W-phase output high */
#define GPIO_FUNC_2_TIM41_OWL   (GPIO_FUNC_2)   /*!< TIM4 channel 1 W-phase output low */

#define GPIO_FUNC_2_TIM42       (GPIO_FUNC_2)   /*!< TIM4 channel*/
#define GPIO_FUNC_2_TIM42_PCT   (GPIO_FUNC_2)   /*!< TIM4 channel 2 @todo */
#define GPIO_FUNC_2_TIM42_ADSM  (GPIO_FUNC_2)   /*!< TIM4 channel 2 @todo */
#define GPIO_FUNC_2_TIM42_CLK   (GPIO_FUNC_2)   /*!< TIM4 channel 2 clock input */
#define GPIO_FUNC_2_TIM42_OUH   (GPIO_FUNC_2)   /*!< TIM4 channel 2 U-phase output high */
#define GPIO_FUNC_2_TIM42_OUL   (GPIO_FUNC_2)   /*!< TIM4 channel 2 U-phase output low */
#define GPIO_FUNC_2_TIM42_OVH   (GPIO_FUNC_2)   /*!< TIM4 channel 2 V-phase output high */
#define GPIO_FUNC_2_TIM42_OVL   (GPIO_FUNC_2)   /*!< TIM4 channel 2 V-phase output low */
#define GPIO_FUNC_2_TIM42_OWH   (GPIO_FUNC_2)   /*!< TIM4 channel 2 W-phase output high */
#define GPIO_FUNC_2_TIM42_OWL   (GPIO_FUNC_2)   /*!< TIM4 channel 2 W-phase output low */

#define GPIO_FUNC_2_TIM43       (GPIO_FUNC_2)   /*!< TIM4 channel*/
#define GPIO_FUNC_2_TIM43_PCT   (GPIO_FUNC_2)   /*!< TIM4 channel 3 @todo */
#define GPIO_FUNC_2_TIM43_ADSM  (GPIO_FUNC_2)   /*!< TIM4 channel 3 @todo */
#define GPIO_FUNC_2_TIM43_CLK   (GPIO_FUNC_2)   /*!< TIM4 channel 3 clock input */
#define GPIO_FUNC_2_TIM43_OUH   (GPIO_FUNC_2)   /*!< TIM4 channel 3 U-phase output high */
#define GPIO_FUNC_2_TIM43_OUL   (GPIO_FUNC_2)   /*!< TIM4 channel 3 U-phase output low */
#define GPIO_FUNC_2_TIM43_OVH   (GPIO_FUNC_2)   /*!< TIM4 channel 3 V-phase output high */
#define GPIO_FUNC_2_TIM43_OVL   (GPIO_FUNC_2)   /*!< TIM4 channel 3 V-phase output low */
#define GPIO_FUNC_2_TIM43_OWH   (GPIO_FUNC_2)   /*!< TIM4 channel 3 W-phase output high */
#define GPIO_FUNC_2_TIM43_OWL   (GPIO_FUNC_2)   /*!< TIM4 channel 3 W-phase output low */
/**
 * @}
 */
...
#define GPIO_FUNC_3_TIM6_TRIG   (GPIO_FUNC_3)   /*!< TIM6 trigger */
#define GPIO_FUNC_3_TIM6_TRIGA  (GPIO_FUNC_3)   /*!< TIM6 trigger A */
#define GPIO_FUNC_3_TIM6_TRIGB  (GPIO_FUNC_3)   /*!< TIM6 trigger B */
#define GPIO_FUNC_3_TIM6_TRIGC  (GPIO_FUNC_3)   /*!< TIM6 trigger C */
#define GPIO_FUNC_3_TIM6_TRIGD  (GPIO_FUNC_3)   /*!< TIM6 trigger D */

#define GPIO_FUNC_3_TIM61       (GPIO_FUNC_3)   /*!< TIM6 uint 1 */
#define GPIO_FUNC_3_TIM61_PWMA  (GPIO_FUNC_3)   /*!< TIM6 uint 1 channel A PWM output */
#define GPIO_FUNC_3_TIM61_PWMB  (GPIO_FUNC_3)   /*!< TIM6 uint 1 channel B PWM output */

#define GPIO_FUNC_3_TIM62       (GPIO_FUNC_3)   /*!< TIM6 uint 2 */
#define GPIO_FUNC_3_TIM62_PWMA  (GPIO_FUNC_3)   /*!< TIM6 uint 2 channel A PWM output */
#define GPIO_FUNC_3_TIM62_PWMB  (GPIO_FUNC_3)   /*!< TIM6 uint 2 channel B PWM output */

#define GPIO_FUNC_3_TIM63       (GPIO_FUNC_3)   /*!< TIM6 uint 3 */
#define GPIO_FUNC_3_TIM63_PWMA  (GPIO_FUNC_3)   /*!< TIM6 uint 3 channel A PWM output */
#define GPIO_FUNC_3_TIM63_PWMB  (GPIO_FUNC_3)   /*!< TIM6 uint 3 channel B PWM output */

#define GPIO_FUNC_3_TIM64       (GPIO_FUNC_3)   /*!< TIM6 uint 4 */
#define GPIO_FUNC_3_TIM64_PWMA  (GPIO_FUNC_3)   /*!< TIM6 uint 4 channel A PWM output */
#define GPIO_FUNC_3_TIM64_PWMB  (GPIO_FUNC_3)   /*!< TIM6 uint 4 channel B PWM output */

#define GPIO_FUNC_3_TIM65       (GPIO_FUNC_3)   /*!< TIM6 uint 5 */
#define GPIO_FUNC_3_TIM65_PWMA  (GPIO_FUNC_3)   /*!< TIM6 uint 5 channel A PWM output */
#define GPIO_FUNC_3_TIM65_PWMB  (GPIO_FUNC_3)   /*!< TIM6 uint 5 channel B PWM output */

#define GPIO_FUNC_3_TIM66       (GPIO_FUNC_3)   /*!< TIM6 uint 6 */
#define GPIO_FUNC_3_TIM66_PWMA  (GPIO_FUNC_3)   /*!< TIM6 uint 6 channel A PWM output */
#define GPIO_FUNC_3_TIM66_PWMB  (GPIO_FUNC_3)   /*!< TIM6 uint 6 channel B PWM output */

#define GPIO_FUNC_3_TIM67       (GPIO_FUNC_3)   /*!< TIM6 uint 7 */
#define GPIO_FUNC_3_TIM67_PWMA  (GPIO_FUNC_3)   /*!< TIM6 uint 7 channel A PWM output */
#define GPIO_FUNC_3_TIM67_PWMB  (GPIO_FUNC_3)   /*!< TIM6 uint 7 channel B PWM output */

#define GPIO_FUNC_3_TIM68       (GPIO_FUNC_3)   /*!< TIM6 uint 8 */
#define GPIO_FUNC_3_TIM68_PWMA  (GPIO_FUNC_3)   /*!< TIM6 uint 8 channel A PWM output */
#define GPIO_FUNC_3_TIM68_PWMB  (GPIO_FUNC_3)   /*!< TIM6 uint 8 channel B PWM output */
...
#define GPIO_FUNC_4_TIMA1       (GPIO_FUNC_4)   /*!< TIMA uint 1 */
#define GPIO_FUNC_4_TIMA1_TRIG  (GPIO_FUNC_4)   /*!< TIMA uint 1 trigger */
#define GPIO_FUNC_4_TIMA1_PWM1  (GPIO_FUNC_4)   /*!< TIMA uint 1 channel 1 PWM output */
#define GPIO_FUNC_4_TIMA1_PWM2  (GPIO_FUNC_4)   /*!< TIMA uint 1 channel 2 PWM output */
#define GPIO_FUNC_4_TIMA1_PWM3  (GPIO_FUNC_4)   /*!< TIMA uint 1 channel 3 PWM output */
#define GPIO_FUNC_4_TIMA1_PWM4  (GPIO_FUNC_4)   /*!< TIMA uint 1 channel 4 PWM output */

#define GPIO_FUNC_4_TIMA2_PWM   (GPIO_FUNC_4)   /*!< TIMA uint 2 PWM */
#define GPIO_FUNC_4_TIMA2_PWM1  (GPIO_FUNC_4)   /*!< TIMA uint 2 channel 1 PWM output */
#define GPIO_FUNC_4_TIMA2_PWM2  (GPIO_FUNC_4)   /*!< TIMA uint 2 channel 2 PWM output */
#define GPIO_FUNC_4_TIMA2_PWM3  (GPIO_FUNC_4)   /*!< TIMA uint 2 channel 3 PWM output */
#define GPIO_FUNC_4_TIMA2_PWM4  (GPIO_FUNC_4)   /*!< TIMA uint 2 channel 4 PWM output */

#define GPIO_FUNC_4_TIMA3       (GPIO_FUNC_4)   /*!< TIMA uint 3 */
#define GPIO_FUNC_4_TIMA3_TRIG  (GPIO_FUNC_4)   /*!< TIMA uint 3 trigger */
#define GPIO_FUNC_4_TIMA3_PWM1  (GPIO_FUNC_4)   /*!< TIMA uint 3 channel 1 PWM output */
#define GPIO_FUNC_4_TIMA3_PWM2  (GPIO_FUNC_4)   /*!< TIMA uint 3 channel 2 PWM output */
#define GPIO_FUNC_4_TIMA3_PWM3  (GPIO_FUNC_4)   /*!< TIMA uint 3 channel 3 PWM output */
#define GPIO_FUNC_4_TIMA3_PWM4  (GPIO_FUNC_4)   /*!< TIMA uint 3 channel 4 PWM output */

#define GPIO_FUNC_4_TIMA4       (GPIO_FUNC_4)   /*!< TIMA uint 4 */
#define GPIO_FUNC_4_TIMA4_TRIG  (GPIO_FUNC_4)   /*!< TIMA uint 4 trigger */
#define GPIO_FUNC_4_TIMA4_PWM1  (GPIO_FUNC_4)   /*!< TIMA uint 4 channel 1 PWM output */
#define GPIO_FUNC_4_TIMA4_PWM2  (GPIO_FUNC_4)   /*!< TIMA uint 4 channel 2 PWM output */
#define GPIO_FUNC_4_TIMA4_PWM3  (GPIO_FUNC_4)   /*!< TIMA uint 4 channel 3 PWM output */
#define GPIO_FUNC_4_TIMA4_PWM4  (GPIO_FUNC_4)   /*!< TIMA uint 4 channel 4 PWM output */

#define GPIO_FUNC_4_TIMA6       (GPIO_FUNC_4)   /*!< TIMA uint 6 */
#define GPIO_FUNC_4_TIMA6_PWM1  (GPIO_FUNC_4)   /*!< TIMA uint 6 channel 1 PWM output */
#define GPIO_FUNC_4_TIMA6_PWM2  (GPIO_FUNC_4)   /*!< TIMA uint 6 channel 2 PWM output */
#define GPIO_FUNC_4_TIMA6_PWM3  (GPIO_FUNC_4)   /*!< TIMA uint 6 channel 3 PWM output */
#define GPIO_FUNC_4_TIMA6_PWM4  (GPIO_FUNC_4)   /*!< TIMA uint 6 channel 4 PWM output */

#define GPIO_FUNC_4_TIMA7       (GPIO_FUNC_4)   /*!< TIMA uint 7 */
#define GPIO_FUNC_4_TIMA7_PWM1  (GPIO_FUNC_4)   /*!< TIMA uint 7 channel 1 PWM output */
#define GPIO_FUNC_4_TIMA7_PWM2  (GPIO_FUNC_4)   /*!< TIMA uint 7 channel 2 PWM output */
#define GPIO_FUNC_4_TIMA7_PWM3  (GPIO_FUNC_4)   /*!< TIMA uint 7 channel 3 PWM output */
#define GPIO_FUNC_4_TIMA7_PWM4  (GPIO_FUNC_4)   /*!< TIMA uint 7 channel 4 PWM output */

#define GPIO_FUNC_4_TIMA8       (GPIO_FUNC_4)   /*!< TIMA uint 8 */
#define GPIO_FUNC_4_TIMA8_PWM1  (GPIO_FUNC_4)   /*!< TIMA uint 8 channel 1 PWM output */
#define GPIO_FUNC_4_TIMA8_PWM2  (GPIO_FUNC_4)   /*!< TIMA uint 8 channel 2 PWM output */
#define GPIO_FUNC_4_TIMA8_PWM3  (GPIO_FUNC_4)   /*!< TIMA uint 8 channel 3 PWM output */
#define GPIO_FUNC_4_TIMA8_PWM4  (GPIO_FUNC_4)   /*!< TIMA uint 8 channel 4 PWM output */

#define GPIO_FUNC_4_TIMA9       (GPIO_FUNC_4)   /*!< TIMA uint 9 */
#define GPIO_FUNC_4_TIMA9_PWM1  (GPIO_FUNC_4)   /*!< TIMA uint 9 channel 1 PWM output */
#define GPIO_FUNC_4_TIMA9_PWM2  (GPIO_FUNC_4)   /*!< TIMA uint 9 channel 2 PWM output */
#define GPIO_FUNC_4_TIMA9_PWM3  (GPIO_FUNC_4)   /*!< TIMA uint 9 channel 3 PWM output */
#define GPIO_FUNC_4_TIMA9_PWM4  (GPIO_FUNC_4)   /*!< TIMA uint 9 channel 4 PWM output */

#define GPIO_FUNC_4_TIMA10      (GPIO_FUNC_4)   /*!< TIMA uint 10 */
#define GPIO_FUNC_4_TIMA10_PWM1 (GPIO_FUNC_4)   /*!< TIMA uint 10 channel 1 PWM output */
#define GPIO_FUNC_4_TIMA10_PWM2 (GPIO_FUNC_4)   /*!< TIMA uint 10 channel 2 PWM output */
#define GPIO_FUNC_4_TIMA10_PWM3 (GPIO_FUNC_4)   /*!< TIMA uint 10 channel 3 PWM output */
#define GPIO_FUNC_4_TIMA10_PWM4 (GPIO_FUNC_4)   /*!< TIMA uint 10 channel 4 PWM output */
/**
 * @}
 */
...
#define GPIO_FUNC_5_TIMA2_TRIG  (GPIO_FUNC_5)   /*!< TIMA uint 2 trigger */

#define GPIO_FUNC_5_TIMA3       (GPIO_FUNC_5)   /*!< TIMA uint 3 */
#define GPIO_FUNC_5_TIMA3_TRIG  (GPIO_FUNC_5)   /*!< TIMA uint 3 trigger */
#define GPIO_FUNC_5_TIMA3_PWM1  (GPIO_FUNC_5)   /*!< TIMA uint 3 channel 1 PWM output */
#define GPIO_FUNC_5_TIMA3_PWM2  (GPIO_FUNC_5)   /*!< TIMA uint 3 channel 2 PWM output */
#define GPIO_FUNC_5_TIMA3_PWM3  (GPIO_FUNC_5)   /*!< TIMA uint 3 channel 3 PWM output */
#define GPIO_FUNC_5_TIMA3_PWM4  (GPIO_FUNC_5)   /*!< TIMA uint 3 channel 4 PWM output */

#define GPIO_FUNC_5_TIMA4       (GPIO_FUNC_5)   /*!< TIMA uint 4 */
#define GPIO_FUNC_5_TIMA4_PWM1  (GPIO_FUNC_5)   /*!< TIMA uint 4 channel 1 PWM output */
#define GPIO_FUNC_5_TIMA4_PWM2  (GPIO_FUNC_5)   /*!< TIMA uint 4 channel 2 PWM output */
#define GPIO_FUNC_5_TIMA4_PWM3  (GPIO_FUNC_5)   /*!< TIMA uint 4 channel 3 PWM output */
#define GPIO_FUNC_5_TIMA4_PWM4  (GPIO_FUNC_5)   /*!< TIMA uint 4 channel 4 PWM output */

#define GPIO_FUNC_5_TIMA5       (GPIO_FUNC_5)   /*!< TIMA uint 5 */
#define GPIO_FUNC_5_TIMA5_TRIG  (GPIO_FUNC_5)   /*!< TIMA uint 5 trigger */
#define GPIO_FUNC_5_TIMA5_PWM1  (GPIO_FUNC_5)   /*!< TIMA uint 5 channel 1 PWM output */
#define GPIO_FUNC_5_TIMA5_PWM2  (GPIO_FUNC_5)   /*!< TIMA uint 5 channel 2 PWM output */
#define GPIO_FUNC_5_TIMA5_PWM3  (GPIO_FUNC_5)   /*!< TIMA uint 5 channel 3 PWM output */
#define GPIO_FUNC_5_TIMA5_PWM4  (GPIO_FUNC_5)   /*!< TIMA uint 5 channel 4 PWM output */

#define GPIO_FUNC_5_TIMA6       (GPIO_FUNC_5)   /*!< TIMA uint 6 */
#define GPIO_FUNC_5_TIMA6_TRIG  (GPIO_FUNC_5)   /*!< TIMA uint 6 trigger */
#define GPIO_FUNC_5_TIMA6_PWM1  (GPIO_FUNC_5)   /*!< TIMA uint 6 channel 1 PWM output */
#define GPIO_FUNC_5_TIMA6_PWM2  (GPIO_FUNC_5)   /*!< TIMA uint 6 channel 2 PWM output */
#define GPIO_FUNC_5_TIMA6_PWM3  (GPIO_FUNC_5)   /*!< TIMA uint 6 channel 3 PWM output */
#define GPIO_FUNC_5_TIMA6_PWM4  (GPIO_FUNC_5)   /*!< TIMA uint 6 channel 4 PWM output */

#define GPIO_FUNC_5_TIMA9       (GPIO_FUNC_5)   /*!< TIMA uint 9 */
#define GPIO_FUNC_5_TIMA9_TRIG  (GPIO_FUNC_5)   /*!< TIMA uint 9 trigger */
#define GPIO_FUNC_5_TIMA9_PWM1  (GPIO_FUNC_5)   /*!< TIMA uint 9 channel 1 PWM output */
#define GPIO_FUNC_5_TIMA9_PWM2  (GPIO_FUNC_5)   /*!< TIMA uint 9 channel 2 PWM output */
#define GPIO_FUNC_5_TIMA9_PWM3  (GPIO_FUNC_5)   /*!< TIMA uint 9 channel 3 PWM output */
#define GPIO_FUNC_5_TIMA9_PWM4  (GPIO_FUNC_5)   /*!< TIMA uint 9 channel 4 PWM output */

#define GPIO_FUNC_5_TIMA11_PWM  (GPIO_FUNC_5)   /*!< TIMA uint 11 PWM */
#define GPIO_FUNC_5_TIMA11_PWM1 (GPIO_FUNC_5)   /*!< TIMA uint 11 channel 1 PWM output */
#define GPIO_FUNC_5_TIMA11_PWM2 (GPIO_FUNC_5)   /*!< TIMA uint 11 channel 2 PWM output */
#define GPIO_FUNC_5_TIMA11_PWM3 (GPIO_FUNC_5)   /*!< TIMA uint 11 channel 3 PWM output */
#define GPIO_FUNC_5_TIMA11_PWM4 (GPIO_FUNC_5)   /*!< TIMA uint 11 channel 4 PWM output */

#define GPIO_FUNC_5_TIMA12_PWM  (GPIO_FUNC_5)   /*!< TIMA uint 12 PWM */
#define GPIO_FUNC_5_TIMA12_PWM1 (GPIO_FUNC_5)   /*!< TIMA uint 12 channel 1 PWM output */
#define GPIO_FUNC_5_TIMA12_PWM2 (GPIO_FUNC_5)   /*!< TIMA uint 12 channel 2 PWM output */
#define GPIO_FUNC_5_TIMA12_PWM3 (GPIO_FUNC_5)   /*!< TIMA uint 12 channel 3 PWM output */
#define GPIO_FUNC_5_TIMA12_PWM4 (GPIO_FUNC_5)   /*!< TIMA uint 12 channel 4 PWM output */
/**
 * @}
 */
...
#define GPIO_FUNC_6_TIMA1_TRIG  (GPIO_FUNC_6)   /*!< TIMA uint 1 trigger */
#define GPIO_FUNC_6_TIMA2_TRIG  (GPIO_FUNC_6)   /*!< TIMA uint 2 trigger */
#define GPIO_FUNC_6_TIMA3_TRIG  (GPIO_FUNC_6)   /*!< TIMA uint 3 trigger */
#define GPIO_FUNC_6_TIMA4_TRIG  (GPIO_FUNC_6)   /*!< TIMA uint 4 trigger */
#define GPIO_FUNC_6_TIMA6_TRIG  (GPIO_FUNC_6)   /*!< TIMA uint 6 trigger */
#define GPIO_FUNC_6_TIMA7_TRIG  (GPIO_FUNC_6)   /*!< TIMA uint 7 trigger */
#define GPIO_FUNC_6_TIMA8_TRIG  (GPIO_FUNC_6)   /*!< TIMA uint 8 trigger */
#define GPIO_FUNC_6_TIMA11_TRIG (GPIO_FUNC_6)   /*!< TIMA uint 11 trigger */
#define GPIO_FUNC_6_TIMA12_TRIG (GPIO_FUNC_6)   /*!< TIMA uint 12 trigger */

#define GPIO_FUNC_6_TIMA5       (GPIO_FUNC_6)   /*!< TIMA uint 5 */
#define GPIO_FUNC_6_TIMA5_TRIG  (GPIO_FUNC_6)   /*!< TIMA uint 5 trigger */
#define GPIO_FUNC_6_TIMA5_PWM1  (GPIO_FUNC_6)   /*!< TIMA uint 5 channel 1 PWM output */
#define GPIO_FUNC_6_TIMA5_PWM2  (GPIO_FUNC_6)   /*!< TIMA uint 5 channel 2 PWM output */
#define GPIO_FUNC_6_TIMA5_PWM3  (GPIO_FUNC_6)   /*!< TIMA uint 5 channel 3 PWM output */
#define GPIO_FUNC_6_TIMA5_PWM4  (GPIO_FUNC_6)   /*!< TIMA uint 5 channel 4 PWM output */

#define GPIO_FUNC_6_TIMA9       (GPIO_FUNC_6)   /*!< TIMA uint 9 */
#define GPIO_FUNC_6_TIMA9_TRIG  (GPIO_FUNC_6)   /*!< TIMA uint 9 trigger */
#define GPIO_FUNC_6_TIMA9_PWM1  (GPIO_FUNC_6)   /*!< TIMA uint 9 channel 1 PWM output */
#define GPIO_FUNC_6_TIMA9_PWM2  (GPIO_FUNC_6)   /*!< TIMA uint 9 channel 2 PWM output */
#define GPIO_FUNC_6_TIMA9_PWM3  (GPIO_FUNC_6)   /*!< TIMA uint 9 channel 3 PWM output */
#define GPIO_FUNC_6_TIMA9_PWM4  (GPIO_FUNC_6)   /*!< TIMA uint 9 channel 4 PWM output */

#define GPIO_FUNC_6_TIMA10      (GPIO_FUNC_6)   /*!< TIMA uint 10 */
#define GPIO_FUNC_6_TIMA10_TRIG (GPIO_FUNC_6)   /*!< TIMA uint 10 trigger */
#define GPIO_FUNC_6_TIMA10_PWM1 (GPIO_FUNC_6)   /*!< TIMA uint 10 channel 1 PWM output */
#define GPIO_FUNC_6_TIMA10_PWM2 (GPIO_FUNC_6)   /*!< TIMA uint 10 channel 2 PWM output */
#define GPIO_FUNC_6_TIMA10_PWM3 (GPIO_FUNC_6)   /*!< TIMA uint 10 channel 3 PWM output */
#define GPIO_FUNC_6_TIMA10_PWM4 (GPIO_FUNC_6)   /*!< TIMA uint 10 channel 4 PWM output */

#define GPIO_FUNC_6_TIM65_PWMA  (GPIO_FUNC_6)   /*!< TIM6 uint 5 channel A PWM output */
#define GPIO_FUNC_6_TIM66_PWMA  (GPIO_FUNC_6)   /*!< TIM6 uint 6 channel A PWM output */
#define GPIO_FUNC_6_TIM67_PWMA  (GPIO_FUNC_6)   /*!< TIM6 uint 7 channel A PWM output */
#define GPIO_FUNC_6_TIM68_PWMA  (GPIO_FUNC_6)   /*!< TIM6 uint 8 channel A PWM output */
 ...
 * @{
 */
#define GPIO_FUNC_8             ((uint8_t)0x08U)
 ...
 * @{
 */
#define GPIO_FUNC_9             ((uint8_t)0x09U)
 ...
 * @{
 */
#define GPIO_FUNC_10                    ((uint8_t)0x0AU)
...
#define GPIO_FUNC_10_TIM22_PWM          (GPIO_FUNC_10)    /*!< TIM2 uint2 PWM */
#define GPIO_FUNC_10_TIM22_PWMA         (GPIO_FUNC_10)    /*!< TIM2 uint2 channel A PWM */
#define GPIO_FUNC_10_TIM22_PWMB         (GPIO_FUNC_10)    /*!< TIM2 uint2 channel B PWM */

#define GPIO_FUNC_10_TIM24_PWM          (GPIO_FUNC_10)    /*!< TIM2 uint4 PWM */
#define GPIO_FUNC_10_TIM24_PWMA         (GPIO_FUNC_10)    /*!< TIM2 uint4 channel A PWM */
#define GPIO_FUNC_10_TIM24_PWMB         (GPIO_FUNC_10)    /*!< TIM2 uint4 channel B PWM */
/**
 * @}
 */
 ...
 * @{
 */
#define GPIO_FUNC_11                ((uint8_t)0x0BU)
 ...
 * @{
 */
#define GPIO_FUNC_12            ((uint8_t)0x0CU)
...
#define GPIO_FUNC_12_EXMC_BAA   (GPIO_FUNC_12)      /*!< Ext. Bus @todo */
 ...
 * @{
 */
#define GPIO_FUNC_13            ((uint8_t)0x0DU)
 ...
 * @{
 */
#define GPIO_FUNC_14            ((uint8_t)0x0EU)
 ...
 * @{
 */
#define GPIO_FUNC_15            ((uint8_t)0x0FU)
 ...
 * @{
 */
#define GPIO_FUNC_16            ((uint8_t)0x10U)
#define GPIO_FUNC_16_TIM21      (GPIO_FUNC_16)      /*!< TIM2 uint1 */
#define GPIO_FUNC_16_TIM21_CLKA (GPIO_FUNC_16)      /*!< TIM2 uint1 channel A CLK input */
#define GPIO_FUNC_16_TIM21_CLKB (GPIO_FUNC_16)      /*!< TIM2 uint1 channel B CLK input */
#define GPIO_FUNC_16_TIM21_PWMA (GPIO_FUNC_16)      /*!< TIM2 uint1 channel A PWM output */
#define GPIO_FUNC_16_TIM21_PWMB (GPIO_FUNC_16)      /*!< TIM2 uint1 channel B PWM output */

#define GPIO_FUNC_16_TIM22      (GPIO_FUNC_16)      /*!< TIM2 uint2 */
#define GPIO_FUNC_16_TIM22_CLKA (GPIO_FUNC_16)      /*!< TIM2 uint2 channel A CLK input */
#define GPIO_FUNC_16_TIM22_CLKB (GPIO_FUNC_16)      /*!< TIM2 uint2 channel B CLK input */
#define GPIO_FUNC_16_TIM22_PWMA (GPIO_FUNC_16)      /*!< TIM2 uint2 channel A PWM output */
#define GPIO_FUNC_16_TIM22_PWMB (GPIO_FUNC_16)      /*!< TIM2 uint2 channel B PWM output */

#define GPIO_FUNC_16_TIM23      (GPIO_FUNC_16)      /*!< TIM2 uint3 */
#define GPIO_FUNC_16_TIM23_CLKA (GPIO_FUNC_16)      /*!< TIM2 uint3 channel A CLK input */
#define GPIO_FUNC_16_TIM23_CLKB (GPIO_FUNC_16)      /*!< TIM2 uint3 channel B CLK input */
#define GPIO_FUNC_16_TIM23_PWMA (GPIO_FUNC_16)      /*!< TIM2 uint3 channel A PWM output */
#define GPIO_FUNC_16_TIM23_PWMB (GPIO_FUNC_16)      /*!< TIM2 uint3 channel B PWM output */

#define GPIO_FUNC_16_TIM24      (GPIO_FUNC_16)      /*!< TIM2 uint4 */
#define GPIO_FUNC_16_TIM24_CLKA (GPIO_FUNC_16)      /*!< TIM2 uint4 channel A CLK input */
#define GPIO_FUNC_16_TIM24_CLKB (GPIO_FUNC_16)      /*!< TIM2 uint4 channel B CLK input */
#define GPIO_FUNC_16_TIM24_PWMA (GPIO_FUNC_16)      /*!< TIM2 uint4 channel A PWM output */
#define GPIO_FUNC_16_TIM24_PWMB (GPIO_FUNC_16)      /*!< TIM2 uint4 channel B PWM output */

#define GPIO_FUNC_16_TIM41_CLK  (GPIO_FUNC_16)      /*!< TIM4 channel 1 CLK input */

#define GPIO_FUNC_16_TIM42_CLK  (GPIO_FUNC_16)      /*!< TIM4 channel 2 CLK input */
#define GPIO_FUNC_16_TIM42_OUL  (GPIO_FUNC_16)      /*!< TIM4 channel 2 U-phase low output */
#define GPIO_FUNC_16_TIM42_OVL  (GPIO_FUNC_16)      /*!< TIM4 channel 2 V-phase low output */
#define GPIO_FUNC_16_TIM42_OWL  (GPIO_FUNC_16)      /*!< TIM4 channel 2 W-phase low output */

#define GPIO_FUNC_16_TIM43_ADSM (GPIO_FUNC_16)      /*!< TIM4 channel 3 @todo */
 ...
 * @{
 */
#define GPIO_FUNC_17            ((uint8_t)0x11U)
 ...
 * @{
 */
#define GPIO_FUNC_18            ((uint8_t)0x12U)
 ...
 * @{
 */
#define GPIO_FUNC_19            ((uint8_t)0x13U)
 ...
 * @{
 */
#define GPIO_FUNC_20            ((uint8_t)0x14U)
 ...
 * @{
 */
#define GPIO_FUNC_32            ((uint8_t)0x20U)
 ...
 * @{
 */
#define GPIO_FUNC_33            ((uint8_t)0x21U)
 ...
 * @{
 */
#define GPIO_FUNC_34            ((uint8_t)0x22U)
 ...
 * @{
 */
#define GPIO_FUNC_35            ((uint8_t)0x23U)
 ...
 * @{
 */
#define GPIO_FUNC_36            ((uint8_t)0x24U)
 ...
 * @{
 */
#define GPIO_FUNC_37            ((uint8_t)0x25U)
 ...
 * @{
 */
#define GPIO_FUNC_38            ((uint8_t)0x26U)
 ...
 * @{
 */
#define GPIO_FUNC_39            ((uint8_t)0x27U)
 ...
 * @{
 */
#define GPIO_FUNC_40            ((uint8_t)0x28U)
 ...
 * @{
 */
#define GPIO_FUNC_41            ((uint8_t)0x29U)
 ...
 * @{
 */
#define GPIO_FUNC_42            ((uint8_t)0x2AU)
 ...
 * @{
 */
#define GPIO_FUNC_43            ((uint8_t)0x2BU)
 ...
 * @{
 */
#define GPIO_FUNC_44            ((uint8_t)0x2CU)
 ...
 * @{
 */
#define GPIO_FUNC_45            ((uint8_t)0x2DU)
 ...
 * @{
 */
#define GPIO_FUNC_46            ((uint8_t)0x2EU)
 ...
 * @{
 */
#define GPIO_FUNC_47            ((uint8_t)0x2FU)
 ...
 * @{
 */
#define GPIO_FUNC_48            ((uint8_t)0x30U)
 ...
 * @{
 */
#define GPIO_FUNC_49            ((uint8_t)0x31U)
 ...
 * @{
 */
#define GPIO_FUNC_50            ((uint8_t)0x32U)
 ...
 * @{
 */
#define GPIO_FUNC_51            ((uint8_t)0x33U)
 ...
 * @{
 */
#define GPIO_FUNC_52            ((uint8_t)0x34U)
#define GPIO_FUNC_52_I2C2_SDA   (GPIO_FUNC_52)      /*!< I2C2 SDA in Function Group 1 */
 ...
 * @{
 */
#define GPIO_FUNC_53            ((uint8_t)0x35U)
#define GPIO_FUNC_53_I2C2_SCL   (GPIO_FUNC_53)      /*!< I2C2 SCL in Function Group 1 */
 ...
 * @{
 */
#define GPIO_FUNC_54            ((uint8_t)0x36U)
 ...
 * @{
 */
#define GPIO_FUNC_55            ((uint8_t)0x37U)
 ...
 * @{
 */
#define GPIO_FUNC_56            ((uint8_t)0x38U)
 ...
 * @{
 */
#define GPIO_FUNC_57            ((uint8_t)0x39U)
 ...
 * @{
 */
#define GPIO_FUNC_58            ((uint8_t)0x3AU)
 ...
 * @{
 */
#define GPIO_FUNC_59            ((uint8_t)0x3BU)
 ...
 * @{
 */
#define GPIO_FUNC_60            ((uint8_t)0x3CU)
 ...
 * @{
 */
#define GPIO_FUNC_61            ((uint8_t)0x3DU)
 ...
 * @{
 */
#define GPIO_FUNC_62            ((uint8_t)0x3EU)
 ...
 * @{
 */
#define GPIO_FUNC_63            ((uint8_t)0x3FU)
 ...
 * @{
 */
#define PIN_LOW_DRV         ((uint16_t)(0UL << GPIO_PCR_DRV_POS))
#define PIN_MID_DRV         ((uint16_t)(1UL << GPIO_PCR_DRV_POS))
#define PIN_HIGH_DRV        ((uint16_t)(2UL << GPIO_PCR_DRV_POS))
/**
 * @}
 */
 ...
 * @{
 */
#define PIN_ATTR_DIGITAL    ((uint16_t)(0UL << GPIO_PCR_DDIS_POS))
#define PIN_ATTR_ANALOG     ((uint16_t)(1UL << GPIO_PCR_DDIS_POS))
/**
 * @}
 */
 ...
 * @{
 */
#define PIN_SUBFUNC_DISABLE ((uint16_t)(0UL << GPIO_PFSR_BFE_POS))
#define PIN_SUBFUNC_ENABLE  ((uint16_t)(1UL << GPIO_PFSR_BFE_POS))
/**
 * @}
 */
