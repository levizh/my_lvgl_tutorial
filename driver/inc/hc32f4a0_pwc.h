...
typedef struct
{
    uint8_t u8LvdEn;        /*!< LVD function setting, @ref PWC_LVD_Config for details */
    uint8_t u8Lvd2ExtInEn;  /*!< LVD2 ext. pin input function setting, @ref PWC_LVD2_ExtIn_Config */
    uint8_t u8LvdCmpOutEn;  /*!< LVD compare output function setting, @ref PWC_LVD_CMP_Config for details */
    uint8_t u8LvdIntRstSel; /*!< LVD interrupt or reset selection, @ref PWC_LVD_IntRst_Sel for details */
    uint8_t u8LvdIntRstEn;  /*!< LVD interrupt or reset function setting, @ref PWC_LVD_IR_Config for details */
    uint8_t u8FilterEn;     /*!< LVD digital filter function setting, @ref PWC_LVD_DF_Config for details */
    uint8_t u8FilterClk;    /*!< LVD digital filter clock setting, @ref PWC_LVD1_DFS_Clk_Sel for details */
    uint8_t u8LvdVoltage;   /*!< LVD detect voltage setting, @ref PWC_LVD_detection_Vol for details */
    uint8_t u8LvdNmiEn;     /*!< LVD NMI function setting, @ref PWC_LVD_Int_Mode_Config for details */
    uint8_t u8LvdTrigger;   /*!< LVD trigger setting, @ref PWC_LVD_Trigger_Sel for details */
 ...
 * @{
 */
#define PWC_LVD2_EXINP_ON   (PWC_PVDCR0_EXVCCINEN)
#define PWC_LVD2_EXINP_OFF  (0x00U)
/**
 * @}
 */

/**
 * @defgroup PWC_LVD_IR_Config PWC LVD Interrupt/Reset Config
 * @{
 */
#define PWC_LVD_IR_ON       (PWC_PVDCR1_PVD1IRE)
#define PWC_LVD_IR_OFF      (0x00U)
/**
 * @}
 */

/**
 * @defgroup PWC_LVD_IntRst_Sel set LVD to interrupt or reset
 * @{
 */
#define PWC_LVD_INT         (0x00U)
#define PWC_LVD_RST         (PWC_PVDCR1_PVD1IRS)
/**
 * @}
 */
 ...
 * @{
 */
#define PWC_LVD_DF_ON       (0x00U)
#define PWC_LVD_DF_OFF      (PWC_PVDFCR_PVD1NFDIS)
/**
 * @}
 */
 ...
 * @{
 */
#define PWC_LVD_DFS_DIV4            (0x00U)                                             /*!< 0.25 LRC cycle */
#define PWC_LVD_DFS_DIV2            (PWC_PVDFCR_PVD1NFCKS_0)                            /*!< 0.5 LRC cycle */
#define PWC_LVD_DFS_DIV1            (PWC_PVDFCR_PVD1NFCKS_1)                            /*!< 1 LRC cycle */
#define PWC_LVD_DFS_MUL2            (PWC_PVDFCR_PVD1NFCKS)                              /*!< 2 LRC cycles */
/**
 * @}
 */

/**
 * @defgroup PWC_LVD_detection_Vol PWC LVD Detection voltage
 * @{
 */
#define PWC_LVD1_2V0_LVD2_2V1        (0x00U)     /*!< Specifies the voltage of PVD1 is 2.0V or PVD2 is 2.0V. */
#define PWC_LVD1_2V1_LVD2_2V3        (0x01U)     /*!< Specifies the voltage of PVD1 is 2.1V or PVD2 is 2.1V. */
#define PWC_LVD1_2V3_LVD2_2V5        (0x02U)     /*!< Specifies the voltage of PVD1 is 2.3V or PVD2 is 2.3V. */
#define PWC_LVD1_2V5_LVD2_2V6        (0x03U)     /*!< Specifies the voltage of PVD1 is 2.5V or PVD2 is 2.5V. */
#define PWC_LVD1_2V6_LVD2_2V7        (0x04U)     /*!< Specifies the voltage of PVD1 is 2.6V or PVD2 is 2.6V. */
#define PWC_LVD1_2V7_LVD2_2V8        (0x05U)     /*!< Specifies the voltage of PVD1 is 2.7V or PVD2 is 2.7V. */
#define PWC_LVD1_2V8_LVD2_2V9        (0x06U)     /*!< Specifies the voltage of PVD1 is 2.8V or PVD2 is 2.8V. */
#define PWC_LVD1_2V9_LVD2_1V1        (0x07U)     /*!< Specifies the voltage of PVD1 is 2.9V or PVD2 is 1.1V (only ext. input). */
/**
 * @}
 */

/**
 * @defgroup PWC_LVD_Int_Mode_Config LVD interrupt set to maskable or non_maskable
 * @{
 */
#define PWC_LVD_INT_MASK            (PWC_PVDICR_PVD1NMIS)
#define PWC_LVD_INT_NONMASK         (0x00U)
/**
 * @}
 */

/**
 * @defgroup PWC_LVD_Trigger_Sel LVD trigger setting
 * @{
 */
#define PWC_LVD_TRIGGER_FALLING    (0x00U)
#define PWC_LVD_TRIGGER_RISING     (PWC_PVDICR_PVD1EDGS_0)
#define PWC_LVD_TRIGGER_BOTH       (PWC_PVDICR_PVD1EDGS_1)
/**
 * @}
 */
 ...
 * @param  u16Module, Lock code for each module.
...
{
    M4_PWC->FPRC = (0xA500U | (uint16_t)((~u16Module) & (M4_PWC->FPRC)));
}

/**
 * @brief  Unlock PWC, CLK, RMU register.
 * @param  u16Module, Unlock code for each module.
 *   @arg  PWC_UNLOCK_CODE_0: 
