...
typedef struct
{
    ...
    uint32_t u32Instruction;                        /*!< Specifies the instruction to be sent.
                                                         This parameter can be a value (8-bit) between 0x00 and 0xFF */
    uint32_t u32Address;                            /*!< Specifies the address to be sent (width from 1 to 4 bytes according u32AddrWidth)
    ...
    uint32_t u32InstructionMode;                    /*!< Specifies the instruction mode.
    ...
    uint32_t u32CmdDummyBytes;                      /*!< Specifies the number of dummy bytes that follows behind instruction.
                                                         See the descriptions about the instructions in the SPI flash datasheet for details.
                                                         This parameter is only for direct communication mode(u32CommMode == QSPI_COMM_DIRECT_COMM) */
} stc_qspi_cmd_t;
...
/**
 * @defgroup QSPI_Prefetch_Command QSPI Prefetch Command
 * @{
 */
 ...
 * @{
 */
#define QSPI_INSTRUCTION_NONE                   (QSPI_CR_IPRSL)         /*!< No instruction. */
#define QSPI_INSTRUCTION_1_LINE                 (0x0U)                  /*!< Instruction on a single line. */
#define QSPI_INSTRUCTION_2_LINE                 (QSPI_CR_IPRSL_0)       /*!< Instruction on 2 lines. */
#define QSPI_INSTRUCTION_4_LINE                 (QSPI_CR_IPRSL_1)       /*!< Instruction on 4 lines. */
/**
 * @}
 */
 ...
 * @{
 */
#define QSPI_ADDR_NONE                          (QSPI_CR_APRSL)         /*!< No address. */
 ...
 * @{
 */
#define QSPI_DATA_NONE                          (QSPI_CR_DPRSL)         /*!< No data. */
...
/**
 * @defgroup QSPI_Serial_Address_Width QSPI Serial Address Width
 * @{
 */
#define QSPI_ADDR_WIDTH_1_BYTE                  (0x0U)                  /*!< QSPI serial address width is 1 byte. */
#define QSPI_ADDR_WIDTH_2_BYTE                  (QSPI_FCR_AWSL_0)       /*!< QSPI serial address width is 2 bytes. */
#define QSPI_ADDR_WIDTH_3_BYTE                  (QSPI_FCR_AWSL_1)       /*!< QSPI serial address width is 3 bytes. */
#define QSPI_ADDR_WIDTH_4_BYTE                  (QSPI_FCR_AWSL_1 | \
                                                 QSPI_FCR_AWSL_0)       /*!< QSPI serial address width is 4 bytes. */
/**
 * @}
 */
...
/**
 * @defgroup QSPI_Write_Protect_Command  QSPI Write Protect Command
 * @{
 */
#define QSPI_WRITE_PROTECT_ENABLE               (0x0U)                  /*!< Enable write-protect. WP(QIO2) ouput low. */
#define QSPI_WRITE_PROTECT_DISABLE              (QSPI_FCR_WPOL)         /*!< Disable write-protect. WP(QIO2) ouput high. */
/**
 * @}
 */
...
void QSPI_WriteProtectCmd(en_functional_state_t enNewState);
