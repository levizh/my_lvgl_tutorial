...
en_result_t ETH_Init(stc_eth_handle_t *pstcEthHandle, stc_eth_init_t *pstcEthInit)
{
    ...
    else
    {
        ...
        else
        {
            ...
            ETH_MAC_Init(pstcEthHandle, &pstcEthInit->stcMacInit);
            ETH_DMA_Init(&pstcEthInit->stcDmaInit);
...
en_result_t ETH_StructInit(stc_eth_init_t *pstcEthInit)
{
    ...
    {
        ETH_MAC_StructInit(&pstcEthInit->stcMacInit);
        ETH_DMA_StructInit(&pstcEthInit->stcDmaInit);
    }
