 ...
 * @brief This example demonstrates DMA repeat transfer function.
 @verbatim
   Change Logs:
   Date             Author          Notes
   2020-03-18       Zhangxl         First version
 @endverbatim
 *******************************************************************************
 ...
 ******************************************************************************/
/**
 * @brief  DMA basical and repeat function init
 * @param  None
 * @retval en_result_t
 */
en_result_t DmaInit(void)
{
    ...
    stcDmaRptInit.u32SrcRptSize = DMA_SRC_RPT_SZ;

    return (DMA_RepeatInit(DMA_UNIT, DMA_CH, &stcDmaRptInit));
}
