/**
 *******************************************************************************
 * @file  eth/lwip_tcp_server/source/main.c
 * @brief This sample code implements a tcp server application based on LwIP
...
/**
 * @addtogroup ETH_LWIP_TCP_Server_RAW
 * @{
 */
...
/**
 * @brief  Main function of ETH LWIP_TCP_Server_RAW.
 * @param  None
