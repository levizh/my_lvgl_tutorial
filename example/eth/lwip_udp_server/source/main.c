/**
 *******************************************************************************
 * @file  eth/lwip_udp_server/source/main.c
 * @brief This sample code implements a udp server application based on LwIP
...
/**
 * @addtogroup ETH_LWIP_UDP_Server_RAW
 * @{
 */
...
/**
 * @brief  Main function of ETH LWIP_UDP_Server_RAW.
 * @param  None
