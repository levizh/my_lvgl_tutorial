/**
 *******************************************************************************
 * @file  exmc/exmc_smc_sram_cy62167ev30ll/source/main.c
...
/**
 * @addtogroup EXMC_SMC_SRAM_CY62167EV30LL
 * @{
 */
 ...
 ******************************************************************************/
#define DATA_BUFFER_LEN                         (0x4000UL)
...
int32_t main(void)
{
    ...
    /* Configure SRAM. */
    CY62167EV30LL_Init();
    CY62167EV30LL_GetMemInfo(&m_u32MemStartAddr, &m_u32MemByteSize);
