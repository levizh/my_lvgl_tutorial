/**
 *******************************************************************************
 * @file  sdioc/fatfs_sd/source/main.c
 * @brief Main program of FatFs SD card for the Device Driver Library.
 @verbatim
   Change Logs:
   Date             Author          Notes
...
/**
 * @brief  Main function of FatFs SD card.
 * @param  None
...
int32_t main(void)
{
    ...
    if (0U == FatFS_LinkDriver(&gSDDriver, SDPath))
    {
