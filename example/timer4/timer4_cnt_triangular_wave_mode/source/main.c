...
static void TMR4_PeakMatch_IrqCallback(void)
{
    ...
    TMR4_CNT_ClearFlag(TMR4_UNIT, TMR4_CNT_FLAG_PEAK);
}
...
int32_t main(void)
{
    ...
    stcTmr4CntInit.u16PeakIntMask = TMR4_CNT_INT_MASK_2;
    stcTmr4CntInit.u16CycleVal = TMR4_CNT_1S_VAL(stcTmr4CntInit.u16ClkDiv)/(4U * (stcTmr4CntInit.u16PeakIntMask + 1U));
