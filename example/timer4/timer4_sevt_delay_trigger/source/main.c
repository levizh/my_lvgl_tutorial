...
#define TMR4_CNT_CYCLE_VAL(div)         ((uint16_t)(Tmr4PclkFreq() / (1UL << (uint32_t)(div)))) /* Period_Value(1000ms) */

/* Timer4 OCO Channel definition */
#define TMR4_OCO_CH                     (TMR4_OCO_UH)

/* Timer4 SEVT port & channel definition */
...
int32_t main(void)
{
    ...
    stcTmr4SevtInit.u16Mode = TMR4_SEVT_MODE_DELAY_TRIGGER;
    stcTmr4SevtInit.u16CompareVal = stcTmr4CntInit.u16CycleVal/4U;
