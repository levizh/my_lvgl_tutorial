/**
 *******************************************************************************
 * @file  timer6\timer6_capture_buf\source\main.c
...
/**
 * @addtogroup TMR6_Capture_Buffer
 * @{
 */
 ...
 * @retval None
 */
void Tmr6_2_CapInput_CallBack(void)
{
...
int32_t main(void)
{
    ...
    stcIrqRegiConf.pfnCallback = &Tmr6_2_CapInput_CallBack;  /* Callback function */
    INTC_IrqSignIn(&stcIrqRegiConf);                        /* Registration IRQ */
