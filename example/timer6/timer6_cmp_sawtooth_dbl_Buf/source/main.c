/**
 *******************************************************************************
 * @file  timer6\timer6_cmp_sawtooth_dbl_buf\source\main.c
...
/**
 * @addtogroup TMR6_Cmp_Sawtooth_Dbl_Buf
 * @{
 */
...
void Tmr6_OverFlow_CallBack(void)
{
    ...
    if( 0U == i)
    {
        TMR6_SetGenCmpReg(M4_TMR6_1, TMR6_CMP_REG_E, 0x3000U);
        TMR6_SetGenCmpReg(M4_TMR6_1, TMR6_CMP_REG_F, 0x6000U);
        i = 1u;
    }
    else if(1U == i)
    {
        TMR6_SetGenCmpReg(M4_TMR6_1, TMR6_CMP_REG_E, 0x4000U);
        TMR6_SetGenCmpReg(M4_TMR6_1, TMR6_CMP_REG_F, 0x4000U);
        i = 2U;
    }
    else
    {
        TMR6_SetGenCmpReg(M4_TMR6_1, TMR6_CMP_REG_E, 0x6000U);
        TMR6_SetGenCmpReg(M4_TMR6_1, TMR6_CMP_REG_F, 0x3000U);
        i = 0U;
    }
}
...
int32_t main(void)
{
    ...
    TMR6_SetGenCmpReg(M4_TMR6_1, TMR6_CMP_REG_E, u32Compare); /* General comprare register E, as buffer register for GCMCR */
    ...
    TMR6_SetGenCmpReg(M4_TMR6_1, TMR6_CMP_REG_F, u32Compare); /* General comprare register F, as buffer register for GCMDR */
