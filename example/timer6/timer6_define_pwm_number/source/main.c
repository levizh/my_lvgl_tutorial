...
int32_t main(void)
{
    ...
    TMR6_HwTrigCfg(TMR6_HW_TRIG_0, EVT_TMR6_2_GOVF);  /* Set EVT_TMR6_2_GOVF Event as Timer6 Trigger Source 0 */
    TMR6_HwTrigCfg(TMR6_HW_TRIG_1, EVT_TMR6_1_GOVF);  /* Set EVT_TMR6_1_GOVF Event as Timer6 Trigger Source1 */
