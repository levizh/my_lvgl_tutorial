...
void Tmr6_UnderFlow_CallBack(void)
{
    ...
    if( 0U == i)
    {
        TMR6_SetGenCmpReg(M4_TMR6_1, TMR6_CMP_REG_C, 0x2000U);
        TMR6_SetGenCmpReg(M4_TMR6_2, TMR6_CMP_REG_C, 0x2000U);
        TMR6_SetGenCmpReg(M4_TMR6_3, TMR6_CMP_REG_C, 0x2000U);
        TMR6_SetGenCmpReg(M4_TMR6_4, TMR6_CMP_REG_C, 0x2000U);
        TMR6_SetGenCmpReg(M4_TMR6_5, TMR6_CMP_REG_C, 0x2000U);
        TMR6_SetGenCmpReg(M4_TMR6_6, TMR6_CMP_REG_C, 0x2000U);
        TMR6_SetGenCmpReg(M4_TMR6_7, TMR6_CMP_REG_C, 0x2000U);
        TMR6_SetGenCmpReg(M4_TMR6_8, TMR6_CMP_REG_C, 0x2000U);
        i = 1U;
    }
    else
    {
        TMR6_SetGenCmpReg(M4_TMR6_1, TMR6_CMP_REG_C, 0x4000U);
        TMR6_SetGenCmpReg(M4_TMR6_2, TMR6_CMP_REG_C, 0x4000U);
        TMR6_SetGenCmpReg(M4_TMR6_3, TMR6_CMP_REG_C, 0x4000U);
        TMR6_SetGenCmpReg(M4_TMR6_4, TMR6_CMP_REG_C, 0x4000U);
        TMR6_SetGenCmpReg(M4_TMR6_5, TMR6_CMP_REG_C, 0x4000U);
        TMR6_SetGenCmpReg(M4_TMR6_6, TMR6_CMP_REG_C, 0x4000U);
        TMR6_SetGenCmpReg(M4_TMR6_7, TMR6_CMP_REG_C, 0x4000U);
        TMR6_SetGenCmpReg(M4_TMR6_8, TMR6_CMP_REG_C, 0x4000U);
...
int32_t main(void)
{
    ...
    TMR6_SetGenCmpReg(M4_TMR6_2, TMR6_CMP_REG_C, u32Compare);

    TMR6_SetGenCmpReg(M4_TMR6_3, TMR6_CMP_REG_A, u32Compare);
    TMR6_SetGenCmpReg(M4_TMR6_3, TMR6_CMP_REG_C, u32Compare);

    TMR6_SetGenCmpReg(M4_TMR6_4, TMR6_CMP_REG_A, u32Compare);
    TMR6_SetGenCmpReg(M4_TMR6_4, TMR6_CMP_REG_C, u32Compare);

    TMR6_SetGenCmpReg(M4_TMR6_5, TMR6_CMP_REG_A, u32Compare);
    TMR6_SetGenCmpReg(M4_TMR6_5, TMR6_CMP_REG_C, u32Compare);

    TMR6_SetGenCmpReg(M4_TMR6_6, TMR6_CMP_REG_A, u32Compare);
    TMR6_SetGenCmpReg(M4_TMR6_6, TMR6_CMP_REG_C, u32Compare);

    TMR6_SetGenCmpReg(M4_TMR6_7, TMR6_CMP_REG_A, u32Compare);
    TMR6_SetGenCmpReg(M4_TMR6_7, TMR6_CMP_REG_C, u32Compare);

    TMR6_SetGenCmpReg(M4_TMR6_8, TMR6_CMP_REG_A, u32Compare);
    TMR6_SetGenCmpReg(M4_TMR6_8, TMR6_CMP_REG_C, u32Compare);
    ...
    TMR6_GenCmpBufCfg(M4_TMR6_3, TMR6_CMP_CHA, &stcBufCfg);
    TMR6_GenCmpBufCfg(M4_TMR6_4, TMR6_CMP_CHA, &stcBufCfg);
    TMR6_GenCmpBufCfg(M4_TMR6_5, TMR6_CMP_CHA, &stcBufCfg);
    TMR6_GenCmpBufCfg(M4_TMR6_6, TMR6_CMP_CHA, &stcBufCfg);
    TMR6_GenCmpBufCfg(M4_TMR6_7, TMR6_CMP_CHA, &stcBufCfg);
    TMR6_GenCmpBufCfg(M4_TMR6_8, TMR6_CMP_CHA, &stcBufCfg);
