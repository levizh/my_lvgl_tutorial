...
typedef struct
{
    uint16_t u16RxPort;             /*!< GPIO_PORT_x, x can be (A~I) to select the GPIO peripheral */

    uint16_t u16RxPin;              /*!< GPIO_PIN_x, x can be (0~15) to select the PIN index */

    uint16_t u16RxPinFunc;          /*!< GPIO_FUNC_x, x can be selected from GPIO function definitions */

    uint16_t u16TxPort;             /*!< GPIO_PORT_x, x can be (A~I) to select the GPIO peripheral */

    uint16_t u16TxPin;              /*!< GPIO_PIN_x, x can be (0~15) to select the PIN index */

    uint16_t u16TxPinFunc;          /*!< GPIO_FUNC_x, x can be selected from GPIO function definitions */
} stc_lin_pin_cfg_t;
